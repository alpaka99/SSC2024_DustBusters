...
@available(macOS 10.15, iOS 12.0, tvOS 13.0, watchOS 6.0, *)
@objc class MyHandPoseClassifier: NSObject {
    let model: MLModel

    /// URL of model assuming it was installed in the same bundle as this class
    class var urlOfModelInThisBundle : URL {
        let resource: String = "Resource/Classifiers/MyHandPoseClassifier"
        let extensionType: String = "mlmodelc"
